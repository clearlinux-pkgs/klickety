...
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/klickety-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/klickety-24.12.3.tar.xz.sig
...
%setup -q -n klickety-24.12.3
cd %{_builddir}/klickety-24.12.3
pushd ..
cp -a klickety-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742462247
mkdir -p clr-build
pushd clr-build
