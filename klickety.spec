...
Source0  : https://download.kde.org/stable/release-service/24.08.1/src/klickety-24.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.1/src/klickety-24.08.1.tar.xz.sig
...
%setup -q -n klickety-24.08.1
cd %{_builddir}/klickety-24.08.1
pushd ..
cp -a klickety-24.08.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726182379
mkdir -p clr-build
pushd clr-build
